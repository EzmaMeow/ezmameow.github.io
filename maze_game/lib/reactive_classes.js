...
//may move to its own class in its own file under lib
//but the other two classes depends on it so may need to group them together or
//have the other two stay here or in the main director ref signal
//also could call the file reactives and provide them all
//probably that which just means renaming this file and moveing it to lib and refactoring
export class Signal {
