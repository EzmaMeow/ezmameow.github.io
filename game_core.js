...
export class Level extends THREE.Scene {
    ...
    #create_static_floor() {
        ...
        floor.position.set(this.level_image.image.height * this.#cell_size.x  / 2.0 - this.#cell_size.x / 2.0, -this.#cell_size.y / 2.0, this.level_image.image.width * this.#cell_size.z / 2.0 - this.#cell_size.z / 2.0);
        this.add(floor);
        return floor;
    }
    #create_static_ceil() {
        ...
        ceil.position.set(this.level_image.image.height * this.#cell_size.x  / 2.0 - this.#cell_size.x / 2.0, this.#cell_size.y / 2.0, this.level_image.image.width * this.#cell_size.z / 2.0 - this.#cell_size.z / 2.0);
        this.add(ceil);
        return ceil;
    }
    get north_border() {
